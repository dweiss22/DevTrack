...
const references: AskReferences = { users: [{ id: "u1", name: "Alex Smith" }], scopes: [{ id: "s1", name: "Course Production" }], projects: [{ id: "p1", name: "Academy Launch" }], statuses: ["In Progress", "Completed"], customFields: [{ id: "00000000-0000-0000-0000-000000000001", name: "Course Type" }], customOptions: [{ fieldId: "00000000-0000-0000-0000-000000000001", fieldName: "Course Type", name: "Course" }] };
describe("Ask DevTrack parser", () => {
  ...
  it("parses custom-field grouping and planned-versus-actual questions", () => {
    const grouped = parseAsk("Show time this quarter by Course Type", references, "America/Chicago", {}, new Date("2026-07-16T18:00:00Z"));
