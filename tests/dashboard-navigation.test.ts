...
describe("application navigation", () => {
  it("uses the requested order, two dividers, and Projects presentation", () => {
    expect(APPLICATION_NAVIGATION.map((entry) => entry.kind === "divider" ? "divider" : entry.label)).toEqual([
      "Dashboard", "Development", "Development Analytics", "SME Dashboard", "ID Dashboard", "Video Dashboard", "Survey Results", "divider", "Projects", "divider", "SME Management", "User Management", "Data", "Surveys"
    ]);
