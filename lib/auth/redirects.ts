const UNSAFE_RETURN_PATHS = new Set(["/login", "/recover", "/auth/callback", "/auth/confirm", "/auth/recovery"]);
const PUBLIC_AUTHENTICATION_PATHS = new Set(["/login", "/recover", "/update-password", "/auth/callback", "/auth/confirm", "/auth/recovery"]);
