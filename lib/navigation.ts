...
export type NavigationEntry =
  | { kind: "link"; id: "dashboard" | "development" | "sme-dashboard" | "id-dashboard" | "surveys" | "projects" | "users" | "data" | "admin-surveys"; href: string; label: string; capability: Capability }
...
export const APPLICATION_NAVIGATION: readonly NavigationEntry[] = [
  ...
  { kind: "link", id: "surveys", href: "/surveys", label: "Surveys", capability: "view_personal_surveys" },
