...
export type NavigationEntry =
  | { kind: "link"; id: "dashboard" | "development" | "sme-dashboard" | "sme-management" | "id-dashboard" | "survey-results" | "projects" | "users" | "data" | "admin-surveys"; href: string; label: string; capability: Capability }
