...
import { loadDashboardAnalytics } from "@/lib/reporting/dashboard";
...
export default async function Dashboard({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const [analytics, statuses, customFields, lastRunResult] = await Promise.all([
    loadDashboardAnalytics(supabase, filters),
