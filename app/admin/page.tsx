...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ connected?: string; error?: string }> }) {
  ...
  return <AppShell isAdmin>
    <header className="page-header"><div><p className="eyebrow">ADMINISTRATIVE FUNCTIONS</p><h1>Data</h1><p>Manage synchronized Wrike data, source folders, unresolved references, and run history.</p></div>
      <a className="button" href="/admin/survey-imports">Historical Survey Imports</a></header>
