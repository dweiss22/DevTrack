...
import { BarChart3, BookOpenCheck, BriefcaseBusiness, ClipboardList, Database, FolderKanban, Gauge, LineChart, LogOut, Menu, UserRound, Users, UsersRound, Video, X } from "lucide-react";
...
const icons = { dashboard: BarChart3, development: BookOpenCheck, insights: LineChart, sme: Users, "sme-dashboard": Gauge, "sme-management": UsersRound, "id-dashboard": UserRound, "video-dashboard": Video, surveys: ClipboardList, "survey-results": ClipboardList, "admin-surveys": ClipboardList, other: UsersRound, projects: FolderKanban, users: BriefcaseBusiness, data: Database };
...
export function SidebarNavigation({ access, lastSynced, profileName, impersonating = false }: { access: AccessProfile; lastSynced?: string | null; profileName: string; impersonating?: boolean }) {
  ...
  const entries = navigationForRole(access);
