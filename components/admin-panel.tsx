...
type Props = { connection: Connection; folderRuns: FolderRun[]; folders: ConfiguredFolder[]; unresolvedReferences: UnresolvedReference[]; verticalDiagnostics: Record<string, unknown> | null; verticalDiagnosticsError: string | null; repairRuns: RepairRun[]; importConflicts: ImportConflict[]; importConflictCount: number; importConflictError: string | null };
