...
export type SmeProjectDetailData = {
  ...
  courseLength: string | null; debrief: SmeDebrief | null;
  finalizedDraft: { available: boolean; url?: string | null; updatedAt?: string | null };
  timeline: {
    startDate: string | null; originalDueDate: string | null; dueDate: string | null;
    projectEndDate: string | null; publishedDate: string | null; lmsPublicationDate: string | null;
  };
