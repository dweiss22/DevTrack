...
import { BarChart3, Clock3, FolderKanban, Settings, UsersRound } from "lucide-react";

const links = [{ href: "/", label: "Overview", icon: BarChart3 }, { href: "/tasks", label: "Tasks", icon: FolderKanban }, { href: "/team", label: "Team", icon: UsersRound }, { href: "/time-entries", label: "Time entries", icon: Clock3 }, { href: "/admin", label: "Administration", icon: Settings }];
